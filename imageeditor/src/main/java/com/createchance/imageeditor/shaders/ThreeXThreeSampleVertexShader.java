 ...
 * @date 2018/11/27
 */
public class ThreeXThreeSampleVertexShader extends AbstractShader {

    private static final String TAG = "ThreeXThreeSampleVertex";

    private final String VERTEX_SHADER = "3x3SampleVertexShader.glsl";
    ...
    public ThreeXThreeSampleVertexShader() {
