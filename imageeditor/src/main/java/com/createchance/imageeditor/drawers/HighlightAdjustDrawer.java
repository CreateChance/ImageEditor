...
import com.createchance.imageeditor.shaders.HighlightAdjustFragmentShader;

import java.nio.FloatBuffer;

/**
 * Highlight adjust drawer.
 *
 * @author createchance
 * @date 2018/11/17
 */
public class HighlightAdjustDrawer extends AbstractDrawer {

    private static final String TAG = "HighlightAdjustDrawer";
    ...
    private HighlightAdjustFragmentShader mFragmentShader;

    public HighlightAdjustDrawer() {
        mVertexShader = new BaseVertexShader();
        mFragmentShader = new HighlightAdjustFragmentShader();
    ...
    public void setHighlight(float highlight) {
        ...
        mFragmentShader.setUHighlight(highlight);
    }
