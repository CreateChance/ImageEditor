...
import com.createchance.imageeditor.shaders.GammaAdjustFragmentShader;
 ...
 * @date 2018/11/17
 */
public class GammaAdjustDrawer extends AbstractDrawer {
    private static final String TAG = "GammaAdjustDrawer";
    ...
    private GammaAdjustFragmentShader mFragmentShader;

    public GammaAdjustDrawer() {
        mVertexShader = new BaseVertexShader();
        mFragmentShader = new GammaAdjustFragmentShader();
    ...
    public void setGamma(float gamma) {
        ...
        mFragmentShader.setUGamma(gamma);
    }
